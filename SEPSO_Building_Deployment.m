...
%read data
[dsm_array,dsm_refmat] = readgeoraster("DSM.tif");
...
b2=-0.8211;
b3=-0.0003795;
min_net_speed=8; %Minimum network speed
...
serverNum = 3; % Number of base stations
...
groupMutationP = 0.5; % Population mutation probability
...
writetable(result_table, 'testPointsNet.csv');
